...
This is the part people get wrong. The intuitive way to organise a working vault is by
subject: a folder per client, a folder per project, everything about that client in one
place. It feels obviously right. It fails within weeks, and here is the mechanism.
...
| `inbox.md` | not sorted yet | n/a | it is drained |
